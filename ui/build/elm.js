...
var $author$project$Main$mockNote = {
	collaborations: _List_Nil,
	created: $elm$time$Time$millisToPosix(0),
	creator: 'me',
	id: 0,
	name: 'my note',
	updated: $elm$time$Time$millisToPosix(1)
};
var $author$project$Main$mockUser = {email: 'me@example.com', name: 'me'};
var $elm$time$Time$utc = A2($elm$time$Time$Zone, 0, _List_Nil);
var $author$project$Main$mockModel = {
	notes: _List_fromArray(
		[$author$project$Main$mockNote, $author$project$Main$mockNote]),
	timeZone: $elm$time$Time$utc,
	user: $author$project$Main$mockUser
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$mockModel,
...
var $author$project$Main$timeFormat = $ryannhg$date_format$DateFormat$format(
	_List_fromArray(
		[
...
var $author$project$Main$viewNote = F2(
	function (m, n) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									'/notes/' + $elm$core$String$fromInt(n.id))
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Main$timeFormat, m.timeZone, n.updated))
						]))
				]));
	});
var $elm$html$Html$br = _VirtualDom_node('br');
var $author$project$Main$viewUserName = function (u) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$href('/users/' + u.name)
			]),
		_List_fromArray(
			[
...
var $author$project$Main$viewUser = function (u) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Main$viewUserName(u),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewUser(model.user),
				A2(
				$elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
				...
				A2(
					$elm$core$List$map,
					function (x) {
						return A2($author$project$Main$viewNote, model, x);
					},
					model.notes))
			]));
};
